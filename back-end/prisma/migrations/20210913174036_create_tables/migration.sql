...
CREATE TABLE `Health_data` (
    ...
    `alergics` VARCHAR(191) NOT NULL DEFAULT 'No Alergias',
    `useCigars` BOOLEAN NOT NULL,
    `howManyCigars` INTEGER NOT NULL DEFAULT 0,
    `useAlcohol` BOOLEAN NOT NULL,
    `howManyAlcohol` VARCHAR(191) NOT NULL DEFAULT 'No alcohol',
    `useDrugs` BOOLEAN NOT NULL,
    `howManyDrugs` VARCHAR(191) NOT NULL DEFAULT 'No drogas',
    `useMedication` BOOLEAN NOT NULL,
    `whichMedications` VARCHAR(191) NOT NULL DEFAULT 'No medicamentos',
